...
<div class="overflow-hidden bgMain">
    ...
    <div id="seccion" class="pt-12 seccion-bloque">
        <div class="flex items-center w-full gap-5 pl-12">
            <span class="w-full titleSection borderSeccion" style="border-color: black">FUNCIONES</span>
        </div>
        ...
        <style>
            :root {
                ...
                --filter-white: brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(7492%) hue-rotate(337deg) brightness(109%) contrast(102%);
            }
    ...
    border-radius: 10px;
        ...
        <div class="acc-container" style="display: contents">
            <button onclick="accordion('acc-section1')" class="acc-btn"><img id="acc-section1-arrow" class="acc-arrow" src="https://www.eurkos.com/assets/arrow_down.svg">Section 1</button>
            <div id="acc-section1" class="acc-hide">
                <ul>
                    <li>
                        <p><a href="#">Item 1</a></p>
                    </li>
            ...
            <button onclick="accordion('acc-section2')" class="acc-btn accent"><img id="acc-section2-arrow" class="acc-arrow" src="https://www.eurkos.com/assets/arrow_down.svg">Section 2</button>
            <div id="acc-section2" class="acc-hide">
                <ul>
                    <li>
                        <p><a href="#">Item 1</a></p>
                    </li>
            ...
            <button onclick="accordion('acc-section3')" class="acc-btn accent"><img id="acc-section3-arrow" class="acc-arrow" src="https://www.eurkos.com/assets/arrow_down.svg">Section 3</button>
            <div id="acc-section3" class="acc-hide">
                <ul>
                    <li>
                        <p><a href="#">Item 1</a></p>
                    </li>
            ...
            <button onclick="accordion('acc-section4')" class="acc-btn accent"><img id="acc-section4-arrow" class="acc-arrow" src="https://www.eurkos.com/assets/arrow_down.svg">Section 4</button>
            <div id="acc-section4" class="acc-hide">
                <ul>
                    <li>
                        <p><a href="#">Item 1</a></p>
                    </li>
        ...
        <ul id="comments-list" class="comments-list">
            ...
            <li onclick="redirigir('{{ $event->title }}')">
                <div class="comment-main-level" onclick="redirigir('{{ $event->title }}')" style="cursor: pointer">
                    <div class="comment-box">
                        <div class="comment-head">
                            <h6 class="comment-name"><a onclick="redirigir('{{ $event->title }}')">{{ $event->title }}</a></h6>
                            <span>{{ $event->startDateFormatted() }}</span>
                            <span style="float: right;display: flex"> <img style="width: 18px;height: 18px;" src="https://cdn-icons-png.flaticon.com/512/992/992700.png" alt=""> {{ $event->location_post_code }} min</span>
                        </div>
