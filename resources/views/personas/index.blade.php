  ...
  <div class="pt-12 footer seccion-bloque">
    ...
    <div class="p-12 swiper slideObras">
        <div class="swiper-wrapper">
            ...
            @foreach ($geventos_destacados as $event2)

            <div class="swiper-slide swiper-slide2 animationShow" onclick="redirigirId('{{ $event2->id }}')">
                @isset($event2->img_mini)
                <img src="{{ asset($event2->img_mini) }}" alt="" />
                @endisset
