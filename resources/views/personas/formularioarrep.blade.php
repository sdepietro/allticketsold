...
{!! Form::open(['url' => route('personas.postContactOrganiser2'), 'class' => 'flex flex-col justify-center items-center reset ajax', 'id' => 'contact-form']) !!}
    <div class="bgLoginForm flex flex-col items-center gap-4 containerRegistro my-10">
		...
		<div style="width: 100%;padding: 0 2em;"><p style="color: white;font-weight: 500;">*Favor de ingresar el evento y el numero de orden en la descripcion</p></div>
