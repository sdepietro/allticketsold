    ...
    <div class="col-md-9">
        <div class="btn-toolbar">
            <div class="btn-group btn-group-responsive">
                <a href="{{ route('clientes.create', ['organiser_id' => $organiser_id]) }}"  class="btn btn-success"><i class="ico-plus"></i> Crear Cliente</a>
            </div>
        </div>
    </div>
@stop
...
@foreach($clientes as $cliente)
		...
		<td class="text-center" style="display: flex;">
        		...
        		<a style="margin-right: 20px;" class="btn btn-xs btn-primary" href="{{ route('clientes.show', ['organiser_id' => $organiser_id, 'id' => $cliente->id]) }}">Detalles</a>
        		<a style="margin-right: 20px;" class="btn btn-xs btn-success" href="{{ route('clientes.edit', ['organiser_id' => $organiser_id, 'id' => $cliente->id]) }}">Editar</a>
