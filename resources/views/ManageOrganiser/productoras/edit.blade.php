...
{!! Form::model($cliente, ['url' => route('perfil.update', ['organiser_id' => $organiser->id, 'id' => $cliente->id]), 'method' => 'PUT', 'class' => 'panel', 'id' => 'edit-form']) !!}
<div class="panel-body">
    ...
    <div class="form-group">
        <p><input class="btn btn-block btn-success" type="submit" value="Actualizar"></p>
    </div>
