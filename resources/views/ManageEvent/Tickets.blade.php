...
@section('page_header')
    ...
    <div class="col-md-3">
        ...
        <div class="input-group">
            <input name='q' value="{{$q}}" placeholder="@lang("Ticket.search_tickets")" type="text" class="form-control">
                    ...
                    <div class="panel panel-success ticket" data-ticket-id="{{$ticket->id}}">
                        ...
                        <div class='panel-body'>
							...
							<ul class="nav nav-section nav-justified mt5 mb5">
								...
								@php
								$ereservadas = $ticket->quantity_available - ($ticket->quantity_remaining + $ticket->quantity_sold);
								@endphp
								<li>
                                    <div class="section">
                                        <h4 class="nm hint--top">
                                        ...
                                        <p class="nm text-muted">Reservadas</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="panel-footer" style="height: 56px;">
                            ...
                            <ul class="nav nav-section nav-justified" style="display:none">
                                <li>
