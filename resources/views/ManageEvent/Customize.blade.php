    ...
    <script>
        $(function () {
            ...
            $('#ticket_design .colorpicker').on('change', function (e) {
				...
				var lugarcolor = $('input[name="googlet"]').val();
				var fechaent = $('input[name="location_lat"]').val();
				var asistente = $('input[name="location_long"]').val();
				var franja = $('input[name="pre_order_display_message"]').val();
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <li style="display:none" data-route="{{route('showEventCustomizeTab', ['event_id' => $event->id, 'tab' => 'design'])}}"
                    class="{{$tab == 'design' ? 'active' : ''}}"><a href="#design" data-toggle="tab">@lang("basic.event_page_design")</a></li>
                <li style="display:none" data-route="{{route('showEventCustomizeTab', ['event_id' => $event->id, 'tab' => 'order_page'])}}"
                ...
                <li style="display:none" data-route="{{route('showEventCustomizeTab', ['event_id' => $event->id, 'tab' => 'affiliates'])}}"
            ...
            <div class="tab-content panel">
                ...
                <div class="tab-pane {{$tab == 'ticket_design' ? 'active' : ''}}" id="ticket_design">
                    {!! Form::model($event, array('url' => route('postEditEventTicketDesign', ['event_id' => $event->id]), 'id' => 'ticketForm', 'class' => 'ajax2')) !!}
                    <div style="display: flex; align-items: center;"><img style="width: 60px;"  class="logo" src="{{asset('assets/images/grafico.png')}}"/><h4 style="color: #718C9F;font-size: medium;font-weight: 700;">Diseño de la entrada</h4></div>
					<br>                   
				   <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('ticket_border_color', 'Color del borde', ['class'=>'control-label required ']) !!}
						...
						<div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('ticket_bg_color', 'Color del fondo', ['class'=>'control-label required ']) !!}
						...
						<div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('imagenmini', 'Imagen del Fondo (600x300)', array('class'=>'control-label ')) !!}
								{!! Form::styledFile('imagenmini') !!}
								<span style="font-size: x-small;color: gray;"><span style="color: red;">*</span> Para visualizar, guarde y actualice</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('ticket_text_color', 'Color del precio', ['class'=>'control-label required ']) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('ticket_sub_text_color', 'Color tipo de entrada', ['class'=>'control-label required ']) !!}
                                {!!  Form::input('text', 'ticket_sub_text_color', old('ticket_sub_text_color'),
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
						...
						<div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('google_tag_manager_code', 'Color del lugar', ['class'=>'control-label required ']) !!}
								{!! Form::input('text', 'googlet', $event->google_tag_manager_code,
									['class'=>'form-control colorpicker', 'placeholder'=>'#000000']) !!}
                            </div>
                        </div>
						<div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('location_lat', 'Color del fecha', ['class'=>'control-label required ']) !!}
                                {!!  Form::input('text', 'location_lat', $event->location_lat,
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
						...
						<div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('location_long', 'Color del asistente', ['class'=>'control-label required ']) !!}
                                {!!  Form::input('text', 'location_long', $event->location_long,
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
						...
						<div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('location_google_place_id', 'Color del QR', ['class'=>'control-label required ']) !!}
                                {!!  Form::input('text', 'location_google_place_id', $event->location_google_place_id,
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
						...
						<h4>Entradas detectadas <span style="font-size: x-small;">(Vista previa no disponible)</span></h4>
						<div class="row">
						<div class="col-md-4" style="display:none">
                            <div class="form-group">
                             
                                {!!  Form::input('hidden', 'location_street_number', $event->location_street_number,
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
						...
						<div class="col-md-4" style="display:none">
                            <div class="form-group">
                                ...
                                {!!  Form::input('hidden', 'post_order_display_message', $event->post_order_display_message,
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
						...
						<div class="col-md-4" style="display:none">
                            <div class="form-group">
                                ...
                                {!!  Form::input('hidden', 'pre_order_display_message', $event->pre_order_display_message,
                                                            [
                                                            'class'=>'form-control colorpicker',
                                                            'placeholder'=>'#000000'
                                                            ])  !!}
							 ...
							 @foreach ($tickets as $ticket)
								<div class="col-md-4">
									<div class="form-group">
										{!! Form::label('color_' . $ticket->id, 'Color para Ticket ' . $ticket->title, ['class'=>'control-label']) !!}
										{!! Form::input('text', 'tickets[' . $ticket->id . '][color]', $ticket->color, [
											'class'=>'form-control colorpicker',
											'placeholder'=>'#000000',
											'autocomplete' => 'off'
											])  !!}
    ...
    // Capturamos el submit del formulario con el ID 'ticketForm'
    $('#ticketForm').submit(function(event) {
        event.preventDefault();  // Prevenimos el envío normal del formulario

        var $form = $(this);
        var formData = new FormData($form[0]); // Usamos FormData para manejar archivos también

        // Realizamos la solicitud AJAX
        $.ajax({
            url: $form.attr('action'),  // Usamos la URL definida en el atributo 'action' del formulario
            type: $form.attr('method'), // Usamos el método definido en el formulario
            data: formData,
            processData: false, // Importantísimo cuando hay archivos
            contentType: false, // Importantísimo cuando hay archivos
            dataType: 'json',
            beforeSend: function() {
            ...
            success: function(data) {
                ...
                if (data.status === 'success') {
                    alert('Diseño del ticket se ha actualizado');
					location.reload();
                    // Si hay redirección o ejecución de código
                    if (data.redirectUrl) {
                        window.location.href = data.redirectUrl;
                    }
                } else {
                    // Manejar errores del servidor, por ejemplo, validaciones
                    if (data.messages) {
            ...
            error: function(xhr, status, error) {
                // Manejar cualquier error de AJAX
