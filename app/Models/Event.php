...
class Event extends MyBaseModel
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'event_image'         => 'nullable|mimes:jpeg,jpg,png|max:20000',
        ];
    }
     ...
     */
     ...
     {
         return $this->belongsTo(GlobalEvent::class);
     }
	...
	public function teatro()
    	{
        return $this->belongsTo(Teatro2::class, 'venue_name', 'id'); // Ajusta los campos si es necesario
    	}
    /**
