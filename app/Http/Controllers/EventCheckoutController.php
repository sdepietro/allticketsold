...
class EventCheckoutController extends Controller
{
    ...
    {
        $order = Order::where('order_referenc', '=', $order_reference)->first();
    ...
    {
        $order = Order::where('id', '=', $order_reference)->first();
...
//            return PDF::html('Public.ViewEvent.Partials.PDFTicket', $data, 'Tickets');
	...
	public function showOrderTickets2(Request $request, $order_reference, $ticket_reference)
    {
	...
	//$ticket = $order->event->tickets()->where('id', $ticket_reference)->first();

	$attendees = $order->attendees()->where('private_reference_number', $ticket_reference)->get();
	...
	$images = [];
        ...
        if ($request->get('download') == '1') {
            return PDF::html('Public.ViewEvent.Partials.PDFTicket2', $data, 'Tickets');

        }
        return view('Public.ViewEvent.Partials.PDFTicket2', $data);
    }
